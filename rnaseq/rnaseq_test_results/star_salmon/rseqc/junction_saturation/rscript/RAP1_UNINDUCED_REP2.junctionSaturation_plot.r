...
y=c(1,2,2,2,2,2,3,3,3,3,3,3,3,3,3,3,3,3,3,3)
z=c(7,11,12,17,22,22,27,32,33,37,38,40,44,49,49,53,55,58,62,63)
w=c(6,9,10,15,20,20,24,29,30,34,35,37,41,46,46,50,52,55,59,60)
m=max(0,0,0)
n=min(0,0,0)
